                ...
                >
                  <Card className="border-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.18)] transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                    <CardContent className="pt-8 text-center space-y-4">
                      ...
                      <p className="text-lg text-muted-foreground">
                        Public transport and ride options tailored for you
                      </p>
                    </CardContent>
                  </Card>
                </motion.div>
          ...
          >
            ...
            <div className="max-w-6xl mx-auto relative z-10">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Who It's For</h2>
                ...
                >
                  <Card className="border-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.18)] transition-all duration-500 h-full relative overflow-hidden bg-gradient-to-br from-card to-card/50 backdrop-blur-sm">
                    <CardContent className="pt-8 space-y-6 relative z-10">
                      ...
                      <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                        Peace of mind knowing your loved ones can travel safely and independently, with optional
                ...
                >
                  <Card className="border-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.18)] transition-all duration-500 h-full relative overflow-hidden bg-gradient-to-br from-card to-card/50 backdrop-blur-sm">
                    <CardContent className="pt-8 space-y-6 relative z-10">
                      ...
                      <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                        Voice-first navigation makes travel truly accessible. No screens required — just speak naturally
                        and receive clear, step-by-step spoken guidance.
                      </p>
                    </CardContent>
                  </Card>
                </motion.div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  Witness the impact firsthand. Experience how simple voice commands can transform your daily travel and
                  independence.
                </p>
